    ...
    <>
      ...
      <Section eyebrow="Legal" title="Terms of Service" intro="Last updated: 24 July 2026">
        <div className="max-w-3xl text-muted-foreground leading-relaxed space-y-6">
          <p>
            By accessing praharshinfrastructure.com you agree to these terms. Content on the site is
            for informational purposes only and does not constitute a binding offer. Project
            execution is governed by the signed proposal, work order or tender terms.
          </p>
          <h3 className="font-display text-2xl text-navy">Intellectual property</h3>
          <p>
            All brand elements, imagery, project descriptions and written content are the property
            of Praharsh Infrastructure and may not be reproduced without written permission.
          </p>
          ...
          <p>
            To the maximum extent permitted by law, Praharsh Infrastructure shall not be liable for
