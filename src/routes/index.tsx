  ...
  head: () => ({
    meta: [
      { title: "Praharsh Infrastructure — EPC Contractor for Civil, Solar & Electrical Projects" },
      {
        name: "description",
        content:
          "Multi-crore EPC contractor delivering government-grade civil, electrical, solar and turnkey infrastructure projects across India.",
      },
...
const sectors = [
  {
    ...
    desc: "Bridges, highways, industrial facilities and high-rise construction.",
  },
  {
    icon: Sun,
    title: "Solar EPC",
    desc: "Utility-scale and rooftop solar plants with full O&M lifecycle.",
  },
  {
    icon: Zap,
    title: "Electrical & T&D",
    desc: "Substations, transmission lines and distribution infrastructure.",
  },
  {
    icon: Landmark,
    title: "Government Projects",
    desc: "Turnkey delivery for central and state PSU contracts.",
  },
];
...
const projects = [
  {
    img: solarImg,
    tag: "Renewables",
    title: "150 MW Solar Park, Rajasthan",
...
function Home() {
  return (
    <>
      ...
      <div className="lg:hidden bg-navy-deep">
        <div className="grid grid-cols-2 px-6 py-2">
          {stats.map((s) => (
            <div
              key={s.l}
              className="px-3 py-6 border-b border-white/10 [&:nth-child(odd)]:border-r"
            >
      ...
      <Section
        eyebrow="Who We Are"
        title="A construction institution built on engineering discipline."
      >
          ...
          <div className="lg:col-span-5 lg:pt-8">
            ...
            <div className="mt-10 space-y-6">
              {[
                {
                  icon: ShieldCheck,
                  t: "Pre-qualified Contractor",
                  d: "Empanelled with PGCIL, NTPC, NHAI, CPWD and 14 state PWDs.",
                },
                {
                  icon: Award,
                  t: "Certified Operations",
                  d: "ISO 9001, 14001 and OHSAS 18001 across every active site.",
                },
                {
                  icon: HardHat,
                  t: "Zero Lost-Time Incidents",
                  d: "27 million safe person-hours over the last 36 months.",
                },
              ].map((b) => (
      ...
      <Section
        ...
        title="Four sectors. One standard of execution."
        muted
        intro="We operate as a single integrated EPC team across civil, power, renewables and government infrastructure — sharing engineering, procurement and HSE systems across every site."
      >
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-px bg-border">
          {sectors.map((s, i) => (
            <div key={s.title} className="bg-background p-10 card-hover group">
              ...
              <Link
                to="/sectors"
                className="mt-8 inline-flex items-center gap-2 text-xs uppercase tracking-widest text-navy group-hover:text-gold transition-colors"
              >
      ...
      <Section
        ...
        intro="Active and recently commissioned works for India's leading PSUs, governments and private developers."
      >
