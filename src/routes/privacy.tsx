  ...
  return (
    <>
      ...
      <Section
        ...
        intro="Last updated: 24 July 2026"
      >
        <div className="prose max-w-3xl text-muted-foreground leading-relaxed space-y-6">
          <p>
            Praharsh Infrastructure (&quot;we&quot;, &quot;our&quot;, &quot;us&quot;) respects your privacy.
            This policy explains what information we collect on
            praharshinfrastructure.com and through our WhatsApp, email and phone channels, and how we use it.
          </p>
          ...
          <p>
            ...
            requesting a quote or contacting us. We do not run any tracking database on this
            website — enquiries reach us directly via WhatsApp or email.
          </p>
          <h3 className="font-display text-2xl text-navy">How we use it</h3>
          <p>
            Solely to respond to your enquiry, prepare proposals, deliver contracted work and
            share periodic updates about our services. We do not sell or rent personal data.
          </p>
          ...
          <p>
            You can request access, correction or deletion of your personal information at any
            time by writing to{" "}
            <a
