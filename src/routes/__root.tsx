...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    ...
    links: [
      ...
      { rel: "icon", type: "image/png", href: "/favicon/favicon-96x96.png?v=20260603", sizes: "96x96" },
      { rel: "icon", type: "image/svg+xml", href: "/favicon/favicon.svg?v=20260603" },
      { rel: "shortcut icon", href: "/favicon/favicon.ico?v=20260603" },
      { rel: "apple-touch-icon", sizes: "180x180", href: "/favicon/apple-touch-icon.png?v=20260603" },
