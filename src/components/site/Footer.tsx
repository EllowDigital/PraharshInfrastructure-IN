    ...
    <footer className="bg-navy-deep text-white/80">
      <div className="mx-auto max-w-7xl px-6 lg:px-10 py-20 grid gap-12 lg:grid-cols-4">
        <div>
          <div className="flex items-center gap-3 mb-6">
            <div className="w-10 h-10 grid place-items-center bg-gold text-navy font-display font-semibold text-lg">P</div>
            <div>
        ...
        <div>
          ...
          <ul className="space-y-3 text-sm">
            <li className="flex gap-3"><MapPin className="w-4 h-4 mt-0.5 text-gold shrink-0" /> Corporate Office, Bengaluru, India</li>
            <li className="flex gap-3"><Phone className="w-4 h-4 mt-0.5 text-gold shrink-0" /> +91 80 0000 0000</li>
            <li className="flex gap-3"><Mail className="w-4 h-4 mt-0.5 text-gold shrink-0" /> contact@praharsh-infra.com</li>
          </ul>
        </div>
      </div>
      <div className="border-t border-white/10">
        <div className="mx-auto max-w-7xl px-6 lg:px-10 py-6 flex flex-col sm:flex-row justify-between gap-4 text-xs text-white/50">
          <div>© {new Date().getFullYear()} Praharsh Infrastructure Pvt. Ltd. CIN: U45200KA2010PTC000000</div>
